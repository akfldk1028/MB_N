...
// ⚠️ 이 클래스는 구버전입니다 (MonoBehaviour)
// 새 버전: Assets/@Scripts/Managers/Contents/BrickGame/BrickGameManager.cs
// 사용 방법: Managers.Game.BrickGame
public class BrickGameManager_Old : MonoBehaviour
{
    [Header("게임 설정")]
